...
**New agent?** Start at [`AGENTS.md`](AGENTS.md). Next build: [`docs/PLAN_NEXT.md`](docs/PLAN_NEXT.md). Pitfalls: [`docs/LEARNINGS.md`](docs/LEARNINGS.md). Tenant product (separate repo): [`docs/TENANT.md`](docs/TENANT.md).
