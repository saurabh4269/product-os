...
export default function CompanyPage() {
  ...
  const shop = data.shop.path.endsWith("/") ? data.shop.path : `${data.shop.path}/`;
  ...
  return (
    <div className="page-pad">
      ...
      <div className="mt-6 flex flex-wrap gap-2">
        ...
        <a href={`${shop}ads.html`} className="rounded-full bg-[var(--elev)] px-4 py-2 text-[14px] font-medium">
          The ad
        </a>
