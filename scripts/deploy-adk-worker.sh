...
ENV_VARS="GOOGLE_CLOUD_PROJECT=${PROJECT},GOOGLE_CLOUD_REGION=${REGION},LOOP_ADK_ENABLED=1,LOOP_ADK_LLM=1,LOOP_DATA_DIR=/app/var,LOOP_STATE_GCS_URI=gs://${BUCKET}/loop_state.db,LOOP_CODE_BACKEND=auto"
