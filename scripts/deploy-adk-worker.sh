...
ENV_VARS="GOOGLE_CLOUD_PROJECT=${PROJECT},GOOGLE_CLOUD_REGION=${REGION},LOOP_ADK_ENABLED=1,LOOP_ADK_LLM=1,LOOP_DATA_DIR=/app/var,LOOP_STATE_GCS_URI=gs://${BUCKET}/loop_state.db,LOOP_CODE_BACKEND=auto,LOOP_USE_VERTEX=1,LOOP_ANTIGRAVITY_VERTEX=1,LOOP_VERTEX_MODEL=gemini-3.5-flash"
